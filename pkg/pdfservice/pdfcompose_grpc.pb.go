...
type PdfServiceClient interface {
	Send(ctx context.Context, in *PostSendParams, opts ...grpc.CallOption) (*PostSendResponse, error)
}
...
func (c *pdfServiceClient) Send(ctx context.Context, in *PostSendParams, opts ...grpc.CallOption) (*PostSendResponse, error) {
	out := new(PostSendResponse)
	err := c.cc.Invoke(ctx, "/pdfservice.PdfService/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PdfServiceServer interface {
	Send(context.Context, *PostSendParams) (*PostSendResponse, error)
...
func (UnimplementedPdfServiceServer) Send(context.Context, *PostSendParams) (*PostSendResponse, error) {
...
func _PdfService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostSendParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PdfServiceServer).Send(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdfservice.PdfService/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PdfServiceServer).Send(ctx, req.(*PostSendParams))
	}
...
var PdfService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Send",
			Handler:    _PdfService_Send_Handler,
		},
	},
